package edu.java.io.addressbook.step02.story;
...
import edu.java.io.addressbook.step02.logic.Indexer;
import edu.java.io.addressbook.step02.logic.MyFileReaderWriter;
import edu.java.io.addressbook.step02.logic.OffsetFinder;
...
public class FileStory {
	...
	public void buildIndex() {
		...
		indexer.createDongIndexFile(indexWriter, indexMap);
	...
	public void findUsingIndex(String dong) {
		...
		List<Long> dongOffsets = indexer.findDongKeyOffset(indexReader, dong);
