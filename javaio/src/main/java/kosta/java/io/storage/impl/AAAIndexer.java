...
public class AAAIndexer {

    private String storageName;
    
    public AAAIndexer(String storageName) {
    ...
    public void addIndex(String key, long location) {
        ...
        try (
            BufferedWriter bw = new BufferedWriter(new OutputStreamWriter(new FileOutputStream(indexFile, true), StorageConfig.INSTANCE.charset()));
        ) {
            bw.write(key);
            bw.write(",");
    ...
    public Long getLocation(String key) {
        ...
        try (
            BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(indexFile), StorageConfig.INSTANCE.charset()));
        ) {
            String line = null;
